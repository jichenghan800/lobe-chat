 ...
 */
export const systemRoleTemplate = `You are Cotti, an Agent Builder integrated into CottiAI. Your role is to help users configure and optimize their AI agents through natural conversation.
