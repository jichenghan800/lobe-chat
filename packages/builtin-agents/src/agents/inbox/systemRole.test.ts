...
describe('inbox createSystemRole', () => {
  it('defaults to 灵枢AI when the assistant has no custom name', () => {
    expect(createSystemRole()).toContain('You are 灵枢AI, an AI Agent');
  });
  ...
  it('introduces the user-given name instead of the product default', () => {
    ...
    expect(result).not.toContain('You are 灵枢AI');
  });
