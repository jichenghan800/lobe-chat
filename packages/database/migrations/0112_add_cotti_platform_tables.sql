CREATE TABLE "cotti_agent_access_rules" (
...
CREATE TABLE "cotti_agent_access_settings" (
...
--> statement-breakpoint
CREATE TABLE "cotti_audit_risk_analyses" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "cotti_audit_view_logs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"admin_user_id" text,
	"admin_email" text,
...
CREATE UNIQUE INDEX "cotti_agent_access_rules_type_value_unique" ON "cotti_agent_access_rules" USING btree ("type","value");--> statement-breakpoint
CREATE UNIQUE INDEX "cotti_audit_risk_analyses_message_id_unique" ON "cotti_audit_risk_analyses" USING btree ("message_id");--> statement-breakpoint
CREATE INDEX "cotti_audit_risk_analyses_status_idx" ON "cotti_audit_risk_analyses" USING btree ("status");--> statement-breakpoint
CREATE INDEX "cotti_audit_risk_analyses_created_at_idx" ON "cotti_audit_risk_analyses" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "cotti_audit_view_logs_admin_user_id_idx" ON "cotti_audit_view_logs" USING btree ("admin_user_id");--> statement-breakpoint
CREATE INDEX "cotti_audit_view_logs_target_idx" ON "cotti_audit_view_logs" USING btree ("target_type","target_id");--> statement-breakpoint
CREATE INDEX "cotti_audit_view_logs_created_at_idx" ON "cotti_audit_view_logs" USING btree ("created_at");--> statement-breakpoint
