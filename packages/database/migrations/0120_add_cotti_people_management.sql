...
--> statement-breakpoint
ALTER TABLE "cotti_login_access_rules" DROP CONSTRAINT IF EXISTS "cotti_login_access_rules_created_by_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "cotti_login_access_settings" DROP CONSTRAINT IF EXISTS "cotti_login_access_settings_updated_by_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "cotti_platform_admin_assignments" DROP CONSTRAINT IF EXISTS "cotti_platform_admin_assignments_user_id_users_id_fk";--> statement-breakpoint
...
ALTER TABLE "cotti_platform_admin_assignments" DROP CONSTRAINT IF EXISTS "cotti_platform_admin_assignments_created_by_users_id_fk";--> statement-breakpoint
