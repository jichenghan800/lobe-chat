...
const vertexaiChatModels: AIChatModelCard[] = [
  {
    ...
    description:
      "Gemini 3.6 Flash is Google's production-ready model for fast, high-quality reasoning, agentic workflows, and grounded multimodal tasks.",
  ...
  },
  {
    ...
    contextWindowTokens: 1_048_576 + 65_536,
    description:
      "Gemini 3.5 Flash-Lite is Google's production-ready, cost-efficient model for high-volume multimodal and agentic workloads.",
