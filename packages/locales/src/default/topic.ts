export default {
  'overview.copyOriginal': 'Copy original topic link',
  'overview.liveReadonly':
    'Read-only \u00B7 checks every 5 seconds \u00B7 saved activity, not browser presence',
  'overview.liveError': 'Refresh failed; showing the last saved result',
  'overview.mode.unknown': 'Mode not recorded',
  'overview.modeInferred': 'Inferred from historical execution; the selected mode was not recorded',
  'overview.modeRecorded': 'Mode recorded for the latest turn',
  'overview.environment.onlyboxes': 'Self-hosted sandbox',
  'overview.environment.market': 'Cloud sandbox',
  'overview.environment.unknown': 'Environment not recorded',
  'overview.activity.waiting': 'Awaiting result (connection status unknown)',
  'overview.activity.error': 'Error recorded',
  'overview.activity.tool': 'Tool result received',
  'overview.activity.reply': 'Reply recorded',
  'overview.activity.unknown': 'No execution result yet',
  ...
  'overview.manage.close': 'Close',
  'overview.manage.loading': 'Loading\u2026',
  'overview.manage.failed': 'Unable to load or save. Please retry.',
  'overview.manage.saved': 'Saved',
  'overview.manage.spent': 'Estimated cost',
  'overview.manage.limit': 'Effective limit',
  'overview.manage.disabled': 'Budget protection off',
  'overview.manage.active': 'Not frozen',
  'overview.manage.frozen': 'Frozen',
  'overview.manage.incomplete': 'Incomplete costs',
  'overview.manage.unknown': 'Cost not recorded',
  'overview.manage.source.topic': 'Topic override',
  'overview.manage.source.user': 'User limit',
  'overview.manage.source.platform': 'Platform default',
  'overview.manage.reason.context': 'Frozen: context limit',
  'overview.manage.reason.budget': 'Frozen: budget limit',
  'overview.manage.reason.manual': 'Frozen by administrator',
  'overview.manage.amountHint':
    'Set the total budget for this topic only. Leave blank to inherit the user or platform limit.',
  'overview.manage.topicLimit': 'Topic limit in CNY',
  'overview.manage.inherit': 'Inherit default limit',
  'overview.manage.save': 'Save limit',
  'overview.manage.freeze': 'Freeze',
  'overview.manage.unfreeze': 'Unfreeze',
  'overview.manage.setLimitAndUnfreeze': 'Save limit and unfreeze',
  'overview.manage.freezeNotice':
    'Stop future requests in this topic. Requests already sent may still complete.',
  'overview.manage.unfreezeNotice':
    'Unfreeze this topic? Requests still undergo context and remaining-budget checks. This does not restart a paused job.',
  'overview.manage.priceHint':
    'Estimated model costs at USD/CNY 7.12. Cache tokens are part of input; estimates and concurrent calls may exceed the limit.',
  'overview.manage.input': 'Input',
  'overview.manage.output': 'Output',
  ...
  'overview.attachmentNotice':
    'Administrator read-only view. Attachments use authorized file links.',
  'overview.backToList': 'Back to topic list',
  'overview.clearSearch': 'Clear search',
  'overview.disabledDescription': 'Enable platform management to use this page.',
  'overview.disabledTitle': 'Topic overview is disabled',
  'overview.emptyDescription': 'Topics created by audited users will appear here.',
  'overview.emptyTitle': 'No topics yet',
  'overview.imageCount_one': '{{count}} image',
  'overview.imageCount_other': '{{count}} images',
  'overview.messageCount_one': '{{count}} message',
  'overview.messageCount_other': '{{count}} messages',
  'overview.mode.agent': 'Agent',
  'overview.mode.chat': 'Chat',
  'overview.mode.task': 'Task',
  'overview.nextPage': 'Next page',
  'overview.noMessagesDescription': 'This topic does not contain any saved messages.',
  'overview.noMessagesTitle': 'No messages',
  ...
  'overview.total_one': '{{count}} topic',
  'overview.total_other': '{{count}} topics',
  'overview.truncated': 'This very long topic shows only its latest 5,000 messages.',
  'overview.untitled': 'Untitled topic',
