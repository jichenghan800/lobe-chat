export default {
  ...
  'platformAnalytics.metric.activeUsers.desc': 'Users who sent at least one message',
  'platformAnalytics.metric.activeUsers.title': 'Active users',
  ...
  'platformManagement.agentAccess.allowlist.desc':
    'Add people by email or user ID. These rules apply only when the mode is set to Selected users.',
  'platformManagement.agentAccess.allowlist.title': 'Selected users',
  ...
  'platformManagement.agentAccess.mode.allowlist.desc':
    'Only enabled people in the list can select Agent mode in a conversation.',
  'platformManagement.agentAccess.mode.allowlist.label': 'Selected users',
  'platformManagement.agentAccess.mode.allowlist.title': 'Open to selected users',
  'platformManagement.agentAccess.mode.desc':
    'This changes whether the Agent mode entry can be selected. Chat, tools, and underlying runtime capabilities are not blocked.',
  'platformManagement.agentAccess.mode.off.desc':
    'No user can select the Agent mode entry. Normal Chat remains available.',
  'platformManagement.agentAccess.mode.off.label': 'Closed',
  'platformManagement.agentAccess.mode.off.title': 'Entry closed',
  'platformManagement.agentAccess.mode.open.desc':
    'Every signed-in user can select Agent mode in a conversation.',
  'platformManagement.agentAccess.mode.open.label': 'Everyone',
  'platformManagement.agentAccess.mode.open.title': 'Open to everyone',
  'platformManagement.agentAccess.mode.title': 'Agent mode entry visibility',
  ...
  'platformManagement.sections.agentAccess': 'Agent entry',
  ...
  'connectorPreset.feishuDocuments.description':
    'Search, list, and read your Feishu documents, or create a new document from a conversation',
