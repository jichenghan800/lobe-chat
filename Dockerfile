...
ARG NEXT_PUBLIC_BRAND_ASSISTANT_NAME
ARG NEXT_PUBLIC_BRAND_LOGO_URL
ARG NEXT_PUBLIC_BRAND_NAME
ARG NEXT_PUBLIC_COTTI_FEEDBACK_EMAIL
ARG NEXT_PUBLIC_COTTI_HIDE_AGENT_CHANNELS
ARG NEXT_PUBLIC_COTTI_HIDE_API_KEY_SETTINGS
ARG NEXT_PUBLIC_COTTI_HIDE_MESSENGER_SETTINGS
ARG NEXT_PUBLIC_COTTI_HIDE_MODEL_PROVIDER_SETTINGS
ARG NEXT_PUBLIC_COTTI_HIDE_SERVICE_MODEL_SETTINGS
ARG NEXT_PUBLIC_COTTI_HOME_HIDDEN_BLOCKS
ARG NEXT_PUBLIC_COTTI_HOME_HIDDEN_STARTER_MODELS
ARG NEXT_PUBLIC_COTTI_MODEL_BUILTIN_SEARCH_ALLOW
ARG NEXT_PUBLIC_COTTI_SHOW_PLATFORM_ANALYTICS
ARG NEXT_PUBLIC_MODEL_DISPLAY_NAMES
ARG NEXT_PUBLIC_MODEL_VISIBLE_ALLOW
ARG NEXT_PUBLIC_NAV_HIDE_VIDEO
ARG FEATURE_FLAGS
ARG LOBE_ROUTE_CHUNK_PRELOAD

ENV NEXT_PUBLIC_BASE_PATH="${NEXT_PUBLIC_BASE_PATH}" \
    FEATURE_FLAGS="${FEATURE_FLAGS}" \
    LOBE_ROUTE_CHUNK_PRELOAD="${LOBE_ROUTE_CHUNK_PRELOAD}"

ENV NEXT_PUBLIC_BRAND_ASSISTANT_NAME="${NEXT_PUBLIC_BRAND_ASSISTANT_NAME}" \
    NEXT_PUBLIC_BRAND_LOGO_URL="${NEXT_PUBLIC_BRAND_LOGO_URL}" \
    NEXT_PUBLIC_BRAND_NAME="${NEXT_PUBLIC_BRAND_NAME}" \
    NEXT_PUBLIC_COTTI_FEEDBACK_EMAIL="${NEXT_PUBLIC_COTTI_FEEDBACK_EMAIL}" \
    NEXT_PUBLIC_COTTI_HIDE_AGENT_CHANNELS="${NEXT_PUBLIC_COTTI_HIDE_AGENT_CHANNELS}" \
    NEXT_PUBLIC_COTTI_HIDE_API_KEY_SETTINGS="${NEXT_PUBLIC_COTTI_HIDE_API_KEY_SETTINGS}" \
    NEXT_PUBLIC_COTTI_HIDE_MESSENGER_SETTINGS="${NEXT_PUBLIC_COTTI_HIDE_MESSENGER_SETTINGS}" \
    NEXT_PUBLIC_COTTI_HIDE_MODEL_PROVIDER_SETTINGS="${NEXT_PUBLIC_COTTI_HIDE_MODEL_PROVIDER_SETTINGS}" \
    NEXT_PUBLIC_COTTI_HIDE_SERVICE_MODEL_SETTINGS="${NEXT_PUBLIC_COTTI_HIDE_SERVICE_MODEL_SETTINGS}" \
    NEXT_PUBLIC_COTTI_HOME_HIDDEN_BLOCKS="${NEXT_PUBLIC_COTTI_HOME_HIDDEN_BLOCKS}" \
    NEXT_PUBLIC_COTTI_HOME_HIDDEN_STARTER_MODELS="${NEXT_PUBLIC_COTTI_HOME_HIDDEN_STARTER_MODELS}" \
    NEXT_PUBLIC_COTTI_MODEL_BUILTIN_SEARCH_ALLOW="${NEXT_PUBLIC_COTTI_MODEL_BUILTIN_SEARCH_ALLOW}" \
    NEXT_PUBLIC_COTTI_SHOW_PLATFORM_ANALYTICS="${NEXT_PUBLIC_COTTI_SHOW_PLATFORM_ANALYTICS}" \
    NEXT_PUBLIC_MODEL_DISPLAY_NAMES="${NEXT_PUBLIC_MODEL_DISPLAY_NAMES}" \
    NEXT_PUBLIC_MODEL_VISIBLE_ALLOW="${NEXT_PUBLIC_MODEL_VISIBLE_ALLOW}" \
    NEXT_PUBLIC_NAV_HIDE_VIDEO="${NEXT_PUBLIC_NAV_HIDE_VIDEO}"
