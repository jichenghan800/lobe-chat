...
describe('useAgentMeta', () => {
  ...
  it('should return Cotti AI title for builtin inbox agent, preserving avatar from backend', () => {
    ...
    // Should override title with Cotti AI, but preserve avatar from backend
    expect(result.current.avatar).toBe('/icons/icon-lobe.png');
    expect(result.current.title).toBe('Cotti AI');
    // Should preserve other properties
    expect(result.current.description).toBe('Inbox description');
  });

  it('should return Cotti AI title for page agent (builtin), preserving avatar from backend', () => {
