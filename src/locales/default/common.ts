export default {
  ...
  'feedback.entry.action': 'Submit feedback',
  'feedback.entry.desc':
    'Report product issues, model errors, upload problems, or usage suggestions. We will include the current page and device context to help locate the issue.',
  'feedback.entry.emailFallback': 'Email support',
  'feedback.entry.title': 'Issue Feedback',
  ...
  'userPanel.feedback': 'Report an Issue',
