...
for key in \
  ...
  APP_URL INTERNAL_APP_URL AUTH_TRUSTED_ORIGINS KEY_VAULTS_SECRET COTTI_AGENT_ACCESS_MODE \
  QSTASH_IMAGE QSTASH_URL QSTASH_TOKEN QSTASH_CURRENT_SIGNING_KEY QSTASH_NEXT_SIGNING_KEY AGENT_RUNTIME_MODE \
