...
context=Path('.records/native-v2216/overview-sidebar-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/overview-sidebar/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-overview-sidebar-20260907 .records/native-v2216/overview-sidebar-image-context
