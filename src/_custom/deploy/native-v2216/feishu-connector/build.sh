...
context=Path('.records/native-v2216/feishu-connector-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/feishu-connector/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-feishu-connector-20260907 .records/native-v2216/feishu-connector-image-context
