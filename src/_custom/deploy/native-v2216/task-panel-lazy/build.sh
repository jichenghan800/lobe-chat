...
context=Path('.records/native-v2216/task-panel-lazy-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/task-panel-lazy/Dockerfile',context/'Dockerfile')
shutil.copyfile('scripts/serverLauncher/startServer.js',context/'startServer.js')
PY
docker build -t lobehub:cotti-v2216-task-panel-lazy-20260908 .records/native-v2216/task-panel-lazy-image-context
