...
context=Path('.records/native-v2216/production-diagnostics-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/production-diagnostics/Dockerfile',context/'Dockerfile')
shutil.copyfile('scripts/serverLauncher/startServer.js',context/'startServer.js')
PY
docker build -t lobehub:cotti-v2216-production-diagnostics-20260908 .records/native-v2216/production-diagnostics-image-context
