...
context=Path('.records/native-v2216/attachments-knowledge-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/attachments-knowledge/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-attachments-knowledge-20260907 .records/native-v2216/attachments-knowledge-image-context
