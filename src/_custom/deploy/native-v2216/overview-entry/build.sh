...
context=Path('.records/native-v2216/overview-entry-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/overview-entry/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-overview-entry-20260907 .records/native-v2216/overview-entry-image-context
