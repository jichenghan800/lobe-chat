...
context=Path('.records/native-v2216/home-memory-reasoning-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/home-memory-reasoning/Dockerfile',context/'Dockerfile')
shutil.copyfile('scripts/serverLauncher/startServer.js',context/'startServer.js')
PY
docker build -t lobehub:cotti-v2216-home-memory-reasoning-20260908 .records/native-v2216/home-memory-reasoning-image-context
