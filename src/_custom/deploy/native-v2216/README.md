...
当前开发镜像：`lobehub:lingshu-v2216-chat-image-preview320-20260911`，生成页和对话 Markdown 图片预览长边上限 320px。独立生产 `chat.cotticoffee.com` 未发布此调整，仍保留 `lobehub:lingshu-v2216-image25-flare-20260911`。通用构建脚本见[build.sh](build.sh)，以独立标签构建，不覆盖现有镜像标签：
