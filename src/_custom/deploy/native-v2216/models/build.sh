...
context=Path('.records/native-v2216/models-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/models/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-models-20260907 .records/native-v2216/models-image-context
