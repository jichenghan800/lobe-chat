...
context=Path('.records/native-v2216/people-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/people-feishu/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-people-feishu-20260907 .records/native-v2216/people-image-context
