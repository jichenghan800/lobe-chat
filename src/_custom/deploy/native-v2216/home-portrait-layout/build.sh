...
context=Path('.records/native-v2216/home-portrait-layout-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/home-portrait-layout/Dockerfile',context/'Dockerfile')
shutil.copyfile('scripts/serverLauncher/startServer.js',context/'startServer.js')
PY
docker build -t "${HOME_PORTRAIT_IMAGE_TAG:-lobehub:cotti-v2216-home-portrait-layout-20260909}" .records/native-v2216/home-portrait-layout-image-context
