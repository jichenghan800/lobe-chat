...
context=Path('.records/native-v2216/sse-null-guard-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/sse-null-guard/Dockerfile',context/'Dockerfile')
shutil.copyfile('scripts/serverLauncher/startServer.js',context/'startServer.js')
PY
docker build -t lobehub:cotti-v2216-sse-null-guard-20260909 .records/native-v2216/sse-null-guard-image-context
