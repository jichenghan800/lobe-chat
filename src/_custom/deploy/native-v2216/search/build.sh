...
context=Path('.records/native-v2216/search-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/search/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-search-20260907 .records/native-v2216/search-image-context
