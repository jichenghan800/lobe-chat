...
context=Path('.records/native-v2216/cost-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/cost/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-cost-20260907 .records/native-v2216/cost-image-context
