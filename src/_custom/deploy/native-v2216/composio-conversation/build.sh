...
context=Path('.records/native-v2216/composio-conversation-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/composio-conversation/Dockerfile',context/'Dockerfile')
shutil.copyfile('scripts/serverLauncher/startServer.js',context/'startServer.js')
PY
docker build -t lobehub:cotti-v2216-composio-conversation-20260908 .records/native-v2216/composio-conversation-image-context
