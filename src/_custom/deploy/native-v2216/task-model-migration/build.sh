...
context=Path('.records/native-v2216/task-model-migration-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/task-model-migration/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-task-model-migration-20260907 .records/native-v2216/task-model-migration-image-context
