...
context=Path('.records/native-v2216/dual-domain-auth-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/dual-domain-auth/Dockerfile',context/'Dockerfile')
shutil.copyfile('scripts/serverLauncher/startServer.js',context/'startServer.js')
PY
docker build -t lobehub:cotti-v2216-dual-domain-auth-20260907 .records/native-v2216/dual-domain-auth-image-context
