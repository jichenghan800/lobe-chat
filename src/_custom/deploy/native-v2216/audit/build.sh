...
context=Path('.records/native-v2216/audit-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/audit/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-audit-20260907 .records/native-v2216/audit-image-context
