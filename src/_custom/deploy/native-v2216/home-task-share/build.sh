...
context=Path('.records/native-v2216/home-task-share-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/home-task-share/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-home-task-share-20260907 .records/native-v2216/home-task-share-image-context
