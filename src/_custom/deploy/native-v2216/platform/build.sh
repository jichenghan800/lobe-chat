...
context=Path('.records/native-v2216/platform-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/platform/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-platform-20260907 .records/native-v2216/platform-image-context
