...
context=Path('.records/native-v2216/restore-management-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/restore-management/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-restore-management-20260907 .records/native-v2216/restore-management-image-context
