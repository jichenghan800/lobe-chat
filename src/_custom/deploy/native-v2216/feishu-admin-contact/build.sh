...
context=Path('.records/native-v2216/feishu-admin-contact-image-context')
...
shutil.copyfile('src/_custom/deploy/native-v2216/feishu-admin-contact/Dockerfile',context/'Dockerfile')
PY
docker build -t lobehub:cotti-v2216-feishu-admin-contact-20260907 .records/native-v2216/feishu-admin-contact-image-context
