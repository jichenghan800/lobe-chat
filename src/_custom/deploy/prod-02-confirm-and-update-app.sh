...
require_env_value VOLCENGINE_API_KEY "豆包2.1-Pro/Seedream 5.0 Lite"
...
set_env .env NEXT_PUBLIC_MODEL_VISIBLE_ALLOW "vertexai/gemini-3.1-flash-lite,vertexai/gemini-3.5-flash,volcengine/doubao-seed-2-1-pro-260628,qwen/qwen3.7-plus,azure/gpt-5.5"
set_env .env NEXT_PUBLIC_MODEL_DISPLAY_NAMES "vertexai/gemini-3.1-flash-lite=COTTI-快速,vertexai/gemini-3.5-flash=COTTI-专业,volcengine/doubao-seed-2-1-pro-260628=豆包2.1-Pro,qwen/qwen3.7-plus=千问3.7-Plus,azure/gpt-5.5=全能效率"
set_env .env NEXT_PUBLIC_COTTI_MODEL_BUILTIN_SEARCH_ALLOW "vertexai/gemini-*,google/gemini-*,volcengine/doubao-seed-2-1-pro-260628,qwen/qwen3.7-plus"
...
set_env .env VOLCENGINE_MODEL_LIST "-all,+doubao-seed-2-1-pro-260628=豆包2.1-Pro<256000:reasoning:vision:fc:video:search>,+doubao-seedream-5-0-260128=Seedream 5.0 Lite"
