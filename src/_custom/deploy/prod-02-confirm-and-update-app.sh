...
set_env .env NEXT_PUBLIC_MODEL_VISIBLE_ALLOW "vertexai/gemini-3.1-flash-lite,vertexai/gemini-3.5-flash,volcengine/doubao-seed-1.6-flash,qwen/qwen3.7-plus,openai/gpt-5.5"
set_env .env NEXT_PUBLIC_MODEL_DISPLAY_NAMES "vertexai/gemini-3.1-flash-lite=COTTI-快速,vertexai/gemini-3.5-flash=COTTI-专业,volcengine/doubao-seed-1.6-flash=豆包1.6-Flash,qwen/qwen3.7-plus=千问3.7-Plus,openai/gpt-5.5=全能效率"
...
set_env .env OPENAI_MODEL_LIST "-all,+gpt-5.5=全能效率<1050000:reasoning:vision:fc>"
