...
require_env_value VOLCENGINE_API_KEY "豆包2.1-Pro/Seedream 5.0 Pro"
...
set_env .env ENABLED_OLLAMA "1"
set_env .env OLLAMA_MODEL_LIST "-all,+lightrag:latest=LightRAG"
set_env .env ENABLED_VOLCENGINE "1"
set_env .env VOLCENGINE_MODEL_LIST "-all,+doubao-seed-2-1-pro-260628=豆包2.1-Pro<256000:reasoning:vision:fc:video:search>,+doubao-seedream-5-0-pro-260628=Seedream 5.0 Pro"
