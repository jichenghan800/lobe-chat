...
const DEFAULT_MODEL_DISPLAY_NAMES =
  'vertexai/gemini-3.1-flash-lite=COTTI-快速,vertexai/gemini-3.5-flash=COTTI-专业,volcengine/doubao-seed-2-1-pro-260628=豆包2.1-Pro,qwen/qwen3.7-plus=千问3.7-Plus,azure/gpt-5.5=全能效率';
